...
void help_1_6_2_8(){
    cout << "\t Шифр Цезаря со сдвигом, зависящим от числа месяца с контрольной суммой,  зависящей от времени (Ш1.2.8).\n\t Каждый чётный день месяца производит сдвиг на 3 для латиницы, на 5 для кириллицы, на 3 для цифр \n \t Каждый нечётный день месяца производит сдвиг на 4 для латиницы, на 6 для кириллицы, на 2 для цифр\n\t После зашифрованного текста присутствует байт, содержащий контрольную сумму от открытого текста./n";
}

void help_1_6_2_9(){
    cout << "\t Шифр Цезаря со сдвигом вправо, зависящим от дня недели с контрольной суммой,  зависящей от времени (Ш1.2.9).\n\t Каждый чётный день недели производит сдвиг на 3 для латиницы, на 5 для кириллицы, на 3 для цифр \n \t Каждый нечётный день недели производит сдвиг на 4 для латиницы, на 6 для кириллицы, на 2 для цифр\n\t После зашифрованного текста присутствует байт, содержащий контрольную сумму от открытого текста./n";
}

void help_1_6_2_10(){
    cout << "\t Шифр Цезаря со сдвигом влево, зависящим от дня недели с контрольной суммой,  зависящей от времени (Ш1.2.10).\n\t Каждый чётный день недели производит сдвиг на 3 для латиницы, на 5 для кириллицы, на 3 для цифр \n \t Каждый нечётный день недели производит сдвиг на 4 для латиницы, на 6 для кириллицы, на 2 для цифр\n\t После зашифрованного текста присутствует байт, содержащий контрольную сумму от открытого текста./n";
}
void help_1_6_2_11(){
    cout << "\t Шифр Цезаря со сдвигом, зависящим от дня недели с контрольной суммой, зависящей от времени (Ш1.2.11).\n\t Каждый чётный день недели производит сдвиг на 3 для латиницы, на 5 для кириллицы, на 3 для цифр \n \t Каждый нечётный день недели производит сдвиг на 3 для латиницы, на 5 для кириллицы, на 3 для цифр\n\t После зашифрованного текста присутствует байт, содержащий контрольную сумму от открытого текста./n";
}

void help_1_6_2_12(){
    cout << "\t Шифр Цезаря о сдвигом, зависящим от дня недели  с контрольной суммой,  зависящей от времени (Ш1.2.12).\n\t Каждый чётный день недели производит сдвиг на 3 для латиницы, на 5 для кириллицы, на 3 для цифр \n \t Каждый нечётный день недели производит сдвиг на 4 для латиницы, на 6 для кириллицы, на 2 для цифр\n\t После зашифрованного текста присутствует байт, содержащий контрольную сумму от открытого текста./n";
}
*/
